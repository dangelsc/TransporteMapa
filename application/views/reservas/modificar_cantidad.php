            ...
            <div class="row">
                <div class="span6">
                    ...
                    <? $producto_id = $p->id?>
                        ...
                        <?endforeach?>
                        <p>
                            <?= form_open("reservas/add_producto/$cliente_id/$reserva_id/$producto_id");?>
                                <?= form_label('Cantidad', 'cantidad');?>
                                <?= form_input(array('id' =>'cantidad' , 'name'=>'cantidad', 'value'=>$cantidad  , 'placeholder'=>'Cantidad de Producto' ));?>
                                <button id="guardar" class="button default">Cambiar Cantidad</button>
                            <?= form_close();?>
                        </p>
                    <?endforeach?>
                </div>
                <div class="span3">
                    <div class="row">
                        <div class="span3 text-right">
                            <?= anchor("reservas/seleccion_productos/$cliente_id/$reserva_id", 'Volver Atras', array('class' => 'button large bg-yellow fg-white', ));?>
                        </div>
                    </div>
                    <div class="row">
                        <div class="span3">
