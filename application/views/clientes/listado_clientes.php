<div class="wrapper margin-top5" >
	<div class="content content-wrapper">
		...
		<div class="content-table" style="margin-top: 60px !important;">
			<div class="content-table-title flex flex-around">
	            <h1 class="table-title" id="_description"> <strong class="table-title-inner fi-eye">Ver Detalle de los Clientes</strong></h1>
			</div>
