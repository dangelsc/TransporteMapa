	...
	<div class="content content-wrapper">
		...
		<div class="content-table">
			<div class="content-table-title flex flex-around">	
				<h1 class="table-title">  <strong class="table-title-inner fi-checkbox">Seleccione Un Cliente Para Registrar Observación</strong></h1>
			</div>
				...
				<tbody>
					...
					<? foreach ($clientes as $fila):?>
						<tr>
							...
							<td><?= $fila->fono?></td>
							<td>
                                <p class=""><?= anchor("cliente/new_observacion/$fila->id", 'Observación', array('class' => 'btn-table-see-detail' ));?></p>
							</td>
						</tr>					
					<? endforeach ?>
				</tbody>
