            ...
            <?foreach ($productos as $fila):?>
                <div class="row">
                    ...
                    <div class="span4">
                        ...
                        <p>
                            <?= anchor("reserva_cliente/stock_producto/$cliente_id/$reserva_id/$fila->id", ' Reservar', array('class' => 'button icon-eye', ));?>
                        </p>
                    </div>
                </div>
        ...
        <div class="span3  bd-black padding5">
            <div class="row">
                <div class="span3 text-right">
                    <?= anchor("reserva_cliente/cancelar_reserva/$reserva_id", 'Cancelar Reserva', array('class' => 'button large bg-yellow fg-white', ));?>
                </div>
            </div>
            <div class="row">
                <div class="span3">
                    <div class="row">
                        <div class="span3">
                            ...
                            <p>
                                <?= anchor("reserva_cliente/confirmar_reserva/$reserva_id/$cliente_id", ' Confirmar Rerserva', array('class' => 'button info icon-newspaper', ));?>
                            </p>
                        </div>
                    </div>
                    ...
                    <?foreach ($productosr as $pr):?>
                        <div class="row">
                            <div class="span3">
                                ...
                                <?endforeach?>
                                <p>
                                    <?= anchor("reserva_cliente/quitar_producto/$pr->id/$reserva_id/$cliente_id", ' Quitar Producto', array('class' => 'button danger icon-cancel', ));?>
                                </p>
                            </div>
                        </div>
                        <div class="row border bd-black"></div>
