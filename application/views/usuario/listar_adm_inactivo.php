    ...
    <div class="content content-wrapper">
        ...
        <div class="content-table">
            <div class="content-table-title flex-around">
                    <h1 class="table-title"><strong class="table-title-inner"> Gestionar Adminstrador</strong></h1>
            </div>
                ...
                <?if($lista_usuarios):?>
                    ...
                    <?foreach ($lista_usuarios as $fila):?>
                        ...
                        <tr>
                            ...
                            <?$id=$fila->id?>
                            <td><?=anchor("usuario/activar_adm/$id","  Activar", array('class'=>'btn-table-desbloquar'))?></p></td>
                        </tr>
