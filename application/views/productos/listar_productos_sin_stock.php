    ...
    <div class="content content-wrapper">
        ...
        <div class="content-table">
            <div class="content-table-title flex-around " style="">   
                <h1 class="table-title"><strong class="table-title-inner fi-list-thumbnails"> Lista de Productos sin Stock</strong></h1>
                <button class="table-print">
                    
                    <?php echo anchor("productos/pdf_almacen_sin_stock/",' ',array('class'=>'block fi-print'))?>
                </button>
                <?if($mensaje!=''):?>
                    <div>
